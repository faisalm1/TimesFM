...
```bash
INIT=$(node "C:/Users/User/Desktop/Cursor 2026/faisalm1/TimesFM/.cursor/get-shit-done/bin/gsd-tools.cjs" init phase-op "${after_phase}")
...
```bash
RESULT=$(node "C:/Users/User/Desktop/Cursor 2026/faisalm1/TimesFM/.cursor/get-shit-done/bin/gsd-tools.cjs" phase insert "${after_phase}" "${description}")
```
